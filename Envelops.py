...
def is_possible_to_fit(rectangle1, rectangle2):
    ...
    :param dict rectangle1: should contain keys "side1" and "side2"
    :param dict rectangle2: should contain keys "side1" and "side2"
...
def sort_envelops(rectangle1, rectangle2):
    ...
    :param dict rectangle1: (dict)should contain keys "side1" and "side2"
    :param dict rectangle2: (dict)should contain keys "side1" and "side2"
...
def validate_side(side):
    ...
    :param str side: side to validate
